-- Guild District Schema Migration (SQLite)
...
CREATE TABLE IF NOT EXISTS guild_district_plots (
    ...
    -- Resource generation
    resource_output TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS guild_resource_generation (
    ...
    resources_generated TEXT NOT NULL, -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS guild_building_types (
    ...
    unlock_requirements TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
    
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Insert default building types
INSERT OR IGNORE INTO guild_building_types (building_type, building_name, description, base_cost, resource_output, maintenance_cost, max_level) VALUES
