-- Faction System Schema Migration (SQLite)
...
CREATE TABLE IF NOT EXISTS player_factions (
    ...
    faction_history TEXT DEFAULT '[]', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS player_characters (
    ...
    genetic_traits TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS resource_consumption_log (
    ...
    faction VARCHAR(20),
    resources_consumed TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS faction_achievements (
    ...
    description TEXT,
    requirements TEXT NOT NULL, -- JSON stored as TEXT in SQLite
    rewards TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS user_faction_achievements (
    ...
    progress TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS faction_events (
    ...
    name VARCHAR(100) NOT NULL,
    description TEXT,
    affected_factions TEXT DEFAULT '[]', -- JSON stored as TEXT in SQLite
    start_time TIMESTAMP NOT NULL,
    end_time TIMESTAMP,
    event_data TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
    active BOOLEAN DEFAULT TRUE,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP
);

-- Insert default faction achievements
INSERT OR IGNORE INTO faction_achievements (achievement_type, name, description, requirements, rewards, faction_specific, rarity) VALUES
