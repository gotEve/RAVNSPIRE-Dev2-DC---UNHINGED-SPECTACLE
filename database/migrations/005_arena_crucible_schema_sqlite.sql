-- Arena/Crucible Schema Migration (SQLite)
...
CREATE TABLE IF NOT EXISTS arena_competitions (
    ...
    participants TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
    ...
    winners TEXT DEFAULT '[]', -- JSON stored as TEXT in SQLite
    results TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS arena_matches (
    ...
    participants TEXT NOT NULL, -- JSON stored as TEXT in SQLite
    winner_id BIGINT,
    winner_guild_id INTEGER REFERENCES guilds(id),
    match_data TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
INSERT OR IGNORE INTO arena_achievements (achievement_type, name, description, requirements, rewards, rarity) VALUES
