-- Marriage and Family System Schema Migration (SQLite)
...
CREATE TABLE IF NOT EXISTS relationship_affection (
    ...
    interaction_history TEXT DEFAULT '[]', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS children (
    ...
    hybrid_composition TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
CREATE TABLE IF NOT EXISTS family_interactions (
    ...
    interaction_data TEXT DEFAULT '{}', -- JSON stored as TEXT in SQLite
...
INSERT OR IGNORE INTO family_achievements (achievement_type, name, description, requirements, rewards, rarity) VALUES
